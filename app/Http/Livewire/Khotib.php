...
class Khotib extends Component
{
    use WithPagination;
    use LivewireAlert;
    ...
    {
        return view('livewire.khotib', [
            'data' => $this->readyToLoad ? User::where('khotib', true)->where('name', 'like', '%' . $this->search . '%')->simplePaginate(10) : [],
        ]);
    }
    ...
    {
        $this->confirm('Nonaktifkan Khotib ?', [
            'toast' => false,
            'position' => 'center',
