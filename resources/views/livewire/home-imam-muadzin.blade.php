<div wire:init="loadPosts">
    <div class="dropdown mt-3 mb-4 float-md-right">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" wire:click="$set('filter','imam')" href="#">Imam</a>
            <a class="dropdown-item" wire:click="$set('filter','muadzin')" href="#">Muadzin</a>
        </div>
    </div>
    <div class="row">
