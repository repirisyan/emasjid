<div wire:init="loadPosts">
    ...
    <div class="card">
        <div class="card-header">
            ...
            {{-- @endif --}}
            <a href="{{ url('ziswaf/keuangan/' . $dari . '/' . $sampai . '/export') }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" wire:model.defer="item"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input min="0" type="number" wire:model.defer="debit" aria-describedby="basic-addon1"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input min="0" type="number" wire:model.defer="kredit" aria-describedby="basic-addon1"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input min="0" type="number" wire:model.defer="saldo" aria-describedby="basic-addon1"
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input min="0" type="number" wire:model.defer="debit_infaq" aria-describedby="basic-addon1"
                                class="form-control @error('debit_infaq') is-invalid @enderror">
                            @error('debit_infaq') <div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            @error('debit_pinjaman') <div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-text" id="basic-addon1">Kredit Infaq</span>
                            <input min="0" type="number" wire:model.defer="kredit_infaq" aria-describedby="basic-addon1"
                                class="form-control @error('kredit_infaq') is-invalid @enderror">
                            @error('kredit_infaq') <div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            @error('kredit_pinjaman') <div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            @error('saldo_infaq_shodaqoh') <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input min="0" type="number" wire:model.defer="piutang" aria-describedby="basic-addon1"
