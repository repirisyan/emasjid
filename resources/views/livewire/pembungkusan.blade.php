                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-prepend">
                                    <button class="input-group-text bg-teal"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input placeholder="Total Pembungkusan"
    ...
    <div wire:ignore.self class="modal fade" id="modalTambah" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <select wire:model.defer="nama" class="form-control @error('nama') is-invalid @enderror">
                            <option>Pilih Pembungkusan Daging</option>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <input type="number" placeholder="Total Bungkus" min="0"
