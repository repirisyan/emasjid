        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" wire:model.defer="konfirmasi"
                            class="form-control @error('konfirmasi') is-invalid @enderror"" placeholder=" KONFIRMASI">
                        <small id="emailHelp" class="form-text text-muted">Ketikan kata : KONFIRMASI</small>
                ...
                <div class="modal-footer">
                    <button type="button" wire:click="resetFields()" class="btn btn-secondary"
                        data-dismiss="modal">Tutup</button>
                    <button type="button" wire:click="tutup_buku()" class="btn btn-primary">Simpan</button>
                </div>
            </div>
        </div>
    </div>
