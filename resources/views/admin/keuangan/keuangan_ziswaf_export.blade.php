    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td>Rp. {{ number_format($debit_infaq + $debit_pinjaman - ($kredit_infaq + $kredit_pinjaman), '0', ',', '.') }}
                </td>
            ...
            <tr>
                ...
                <td>Rp. {{ number_format($debit - $kredit + ($debit_infaq + $debit_pinjaman - ($kredit_infaq + $kredit_pinjaman)),'0',',','.') }}
                </td>
                <td></td>
                <td></td>
                <td></td>
